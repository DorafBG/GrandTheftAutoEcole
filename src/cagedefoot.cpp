    ...
    : Shape(shader), color_(color)
{
    ...
    float rayon = 0.07f;   // épaisseur des cylindres
    float largeur = 2.44f; // largeur officielle, tu peux ajuster
...
void CageDeFoot::draw(glm::mat4& model, glm::mat4& view, glm::mat4& projection)
{
    ...
    // Barre transversale (horizontale, sur X au sommet, pas de rotation)
